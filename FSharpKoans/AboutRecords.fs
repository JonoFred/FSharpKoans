...
module ``07: On the Record`` =
    ...
    let ``01 Creating records`` () =
        let myRecord = {Book.Author = "Brandon Sanderson"; Book.Title = "Steelheart"; Book.Year = 2013}
    ...
    let ``03 Decomposing with a record pattern`` () =
        ...
        let a = book
        a.Title |> should equal "Dune" // DO NOT use a . symbol in your answer
        a.Year |> should equal 1965 // DO NOT use a . symbol in your answer
